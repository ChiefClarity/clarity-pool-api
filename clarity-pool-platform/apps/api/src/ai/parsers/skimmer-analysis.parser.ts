...
export const SkimmerResponseSchema = z.object({
  ...
  skimmers: z
    .array(
      z.object({
        basketCondition: z
          .enum(['clean', 'dirty', 'damaged', 'missing'])
          .optional(),
...
@Injectable()
export class SkimmerAnalysisParser extends BaseAnalysisParser<
  typeof SkimmerResponseSchema,
  ParsedSkimmerAnalysis
> {
  ...
  protected mapToAnalysisStructure(
    data: z.infer<typeof SkimmerResponseSchema>,
  ): ParsedSkimmerAnalysis {
    return {
